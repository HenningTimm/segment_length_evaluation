...
Facets of bar plots, rows share a hash function, columns canonization strategy.
Empiric data is shown as bars, predictions as a line plot.
"""
...
def df_from_files(data_files):
    ...
    # drop all unneeded columns columns
    prediction = (prediction[["Segment Length", "Expected Probability"]])

    all_dfs = []
    for data_file in data_files:
        w, q, _, canon, hf, gc, genome, k = parse_filename(data_file)
